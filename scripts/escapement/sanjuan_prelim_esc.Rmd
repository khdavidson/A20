...
For 2023 estimate used expanded PL+D of 41 adults and 1 jack. Given that peak count occurred Oct 10-12 and most were not spawning, still need to rmeove ~4 Harris adults so that final estimate is 37 adults + 1 jack. *This is subject to change; see EscBatchHardCopy report for specific estimate abundance.*
...
For 2023 estimate used expanded PL+D of 1844 adults and 102 jack. Given that peak count occurred Oct 27-29 and most were not spawning, still need to remove ~1153 Harris and 408 Lens adults so that final estimate is 37 adults + 1 jack. *This is subject to change; see EscBatchHardCopy report for specific estimate abundance.*
...
Figure: Expanded live adult chinook Chinook (bars) and carcasses (black line). Bar fill colur indicates behaviour (spawning=gray, holding=white) while bar outline colour indicates river segment (lower=pink, mid=green, upper=blue). Note Oct 3/4 mid was covered within upper and lower.  
...
For 2023 estimate we went with the expanded PL+D on Oct 4, even though there was potential for double-counting one school between the Oct 3/4 surveys (see above). Given that the majority of chinook were not observed to be holding at this time and trib swims occured a couple of weeks later, trib counts should be subtracted from the total estimate. The PL+D estimate is 2642 adults + 67 jacks. *This is subject to change; see EscBatchHardCopy report for specific estimate abundance.*
