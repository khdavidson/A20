...
# ============================== SEP RELEASES ==============================
SJRelSEP <- lapply(list.files(path ="C:/Users/DAVIDSONKA/Documents/ANALYSIS/San_Juan/data/enhancement-PNI/",
...
```{r}
SJ_mark_history %>%
  kbl(align="c", caption="Age structure of San Juan Chinook (excludes tributaries). Data from NuSEDS.", format.args=list(big.mark=",")) %>%
