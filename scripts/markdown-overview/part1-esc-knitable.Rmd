...
SJ_allAgesMaster <- readxl::read_excel(path=list.files(path="//ENT.dfo-mpo.ca/DFO-MPO/GROUP/PAC/PBS/Operations/SCA/SCD_Stad/WCVI/CHINOOK/WCVI_TERMINAL_RUN/Annual_data_summaries_for_RunRecons/",
                                                  pattern = "^R_OUT - ALL South Coast Chinook Age results",
                                                  full.names = T),
                                       guess_max=20000) %>%
