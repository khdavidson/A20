...
# ====================== ENUMERATION data ====================== 
nuseds_cn_yrs <- getNuSEDS(here("scripts", "json", "nuseds_esc_query_A20.json"), password=NULL)%>%
...
RPs <- read.csv("C:/Users/DAVIDSONKA/Documents/ANALYSIS/San_Juan/data/escapement/wcviCK-BootstrappedRPs.csv") %>%
