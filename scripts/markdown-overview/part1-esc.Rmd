...
a20_nuseds_escapement <- readxl::read_excel(path=here("outputs", 
...
sj.esc <- full_join(a20_nuseds_escapement,
                    readxl::read_excel("//dcbcpbsna01a.ENT.dfo-mpo.ca/SCD_Stad/WCVI/ESCAPEMENT/Data/NEW ESCAPEMENT INDEX.xls", 
