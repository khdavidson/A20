...
### *********** HERE NEXT DAY: NEED TO SIMPLIFY OR FIX HOW THE DIFFERENT LEVEL STOCK ROLLUPS WILL WORK
# PROBABLY NEED TO LEAVE BROADER AND THEN SUMMARIZE WITHIN PLOTS WHETHER IT'S LEVEL 2 OR 3   *******
...
ggplotly(
  ggplot(data = WCVIcrestBDWR.catEst.sj %>% 
    ...
    geom_ribbon(data = WCVIcrestBDWR.catEst.sj %>% 
                ...
                fill="gray80", colour="gray80", alpha=0.2, size=1000) +
    geom_ribbon(data = WCVIcrestBDWR.catEst.sj %>% 
...
#### San Juan origin across WCVI

Applying stock comp %s from creel biosamples to estimated catch by Month/Area/Year. 
