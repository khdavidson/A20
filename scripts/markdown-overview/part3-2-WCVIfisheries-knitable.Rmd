...
pdf(file = here::here("outputs", "figures", "WCVI SJ catch estimate map 2023.pdf"),   
    width = 11, # The width of the plot in inches
    height = 8.5) # The height of the plot in inches

#ggplotly(
ggplot() +
  geom_sf(data=wcviPFMA_sjCatEst %>% 
            sf::st_set_crs(.,"WGS84") %>% 
            filter(YEAR=="2023") %>%
            filter(MONTH%in%c("May", "June", "July", "August", "September")), 
          aes(fill=round(inverse_estKeptByID, 0), text=paste0("PFMA ", STATAREA)), colour=alpha("gray60", 0.5), linewidth=0.5) +
...
pdf(file = here::here("outputs", "figures", "WCVI SJ catch estimate map 2022.pdf"),   
    width = 11, # The width of the plot in inches
    height = 8.5) # The height of the plot in inches
...
ggplot() +
  geom_sf(data=wcviPFMA_sjCatEst %>% 
            sf::st_set_crs(.,"WGS84") %>% 
            filter(MONTH%in%c("May", "June", "July", "August", "September"), YEAR=="2022"),
          aes(fill=round(inverse_estKeptByID,0), text=paste0("PFMA ", STATAREA)), colour=alpha("gray60", 0.5), linewidth=0.5) +
  #scale_fill_viridis_b(na.value = NA) +
  paletteer::scale_fill_paletteer_c("viridis::plasma", na.value = NA) +
  geom_sf(data=rnaturalearth::ne_countries(type="countries", scale="large", returnclass="sf"), 
...
```{r wcvi21}
pdf(file = here::here("outputs", "figures", "WCVI SJ catch estimate map 2021.pdf"),   
    width = 11, # The width of the plot in inches
    height = 8.5) # The height of the plot in inches
...
ggplot() +
  geom_sf(data=wcviPFMA_sjCatEst %>% 
            sf::st_set_crs(.,"WGS84") %>% 
            filter(MONTH%in%c("May", "June", "July", "August", "September"), YEAR=="2021"), 
          aes(fill=round(inverse_estKeptByID,0), text=paste0("PFMA ", STATAREA)), colour=alpha("gray60", 0.5), linewidth=0.5) +
  scale_fill_viridis_b(na.value = NA) +
  geom_sf(data=rnaturalearth::ne_countries(type="countries", scale="large", returnclass="sf"), 
          colour="transparent", fill="black") +
  coord_sf(crs="+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0", xlim=c(-129, -123), ylim=c(51.5, 48)) +
  labs(fill="Estimated number of kept \nSan Juan Chinook 2021") +
  theme_bw() +
  theme(axis.text = element_blank(),
        legend.title = element_text(face="bold", size=20),
        legend.text = element_text(size=19),
...
```{r wcvi20, eval=F}
pdf(file = here::here("outputs", "figures", "WCVI SJ catch estimate map 2020.pdf"),   
    width = 11, # The width of the plot in inches
    height = 8.5) # The height of the plot in inches
...
ggplot() +
  geom_sf(data=wcviPFMA_sjCatEst %>% 
            sf::st_set_crs(.,"WGS84") %>% 
            filter(MONTH%in%c("May", "June", "July", "August", "September"), YEAR=="2020"), 
          aes(fill=round(inverse_estKeptByID,0), text=paste0("PFMA ", STATAREA)), colour=alpha("gray60", 0.5), linewidth=0.5) +
  scale_fill_viridis_b(na.value = NA) +
  geom_sf(data=rnaturalearth::ne_countries(type="countries", scale="large", returnclass="sf"), 
          colour="transparent", fill="black") +
  coord_sf(crs="+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0", xlim=c(-129, -123), ylim=c(51.5, 48)) +
  labs(fill="Estimated number of kept \nSan Juan Chinook 2020") +
  theme_bw() +
  theme(axis.text = element_blank(),
        legend.title = element_text(face="bold", size=20),
        legend.text = element_text(size=19),
