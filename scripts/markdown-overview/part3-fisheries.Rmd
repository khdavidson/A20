...
# open PDF to save
pdf(file = here("scripts", "markdown-overview", "SanJuan_DC_files", "figure-html", "SJ CWT recoveries coastwide - all years.pdf"),   
...
ggplot() +
  ...
  geom_jitter(data=a20cwtRcvy.spatial%>%
                ...
                summarize(totalExp = sum(`(RC) Expanded Number`)), 
              aes(x=long, y=lat, colour=`Fishery PSC Code english`, fill=`Fishery PSC Code english`, 
                  size=totalExp, shape=`Fishery Series`), alpha=0.6, width=0.2, height=0.2) +
  scale_size(range=c(2,5)) +
  scale_shape_manual(values=c(21,22,23,24,25)) +
  labs(x="", y="", fill="PSC Fishery Gear", colour="PSC Fishery Gear", shape="Fishery group", size="Number of Chinook (expanded CWTs)") +
  theme_bw() +
...
# open PDF to save
pdf(file = here("scripts", "markdown-overview", "SanJuan_DC_files", "figure-html", "SJ CWT recoveries coastwide - PST19.pdf"),   
    width = 11, height = 8.5)    # inches
